...
\033[1;33m
 _   _    _    ____ _  __  _____ ___   ___  _     ____
| | | |  / \  / ___| |/ / |_   _/ _ \ / _ \| |   / ___|
| |_| | / _ \| |   | ' /    | || | | | | | | |   \___ \
|  _  |/ ___ \ |___| . \    | || |_| | |_| | |___ ___) |
|_| |_/_/   \_\____|_|\_\   |_| \___/ \___/|_____|____/ \033[1;91mv2.1
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install Tool-Hack.\033[1;m
...
\033[1;33m    [ + ] \033[1;32mTo run Tool-Hack.
\033[1;33m    [ + ] \033[1;32mType Tool-Hack in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your Tool-Hack.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mTool-Hack Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update Tool-Hack.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mTool-Hack
\033[1;33m       [+] Author :- \033[1;32mW4R15.SEC
\033[1;33m       [+] Latest Update :- \033[1;32m18/03/2022.\033[1;m
\033[1;33m       [+] Tools :- \033[1;32mtotal {total} tools.\033[1;m

\033[1;33m [+] \033[1;32mTool-Hack is automatic tool installer.
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating Tools-Hack ______________|
 \033[01;33m=============================================\033[00m""")
