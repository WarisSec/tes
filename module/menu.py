    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Tools-Hack"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/rajkumardusad/Tool-X.git "+system.home+"/Tool-X")
            if os.path.exists(system.home+"/Tools-Hack/install.aex"):
              os.system("cd "+system.home+"/Tools-Hack && "+system.sudo+" sh install.aex")
              if os.path.exists(system.bin+"/Tools-Hack") and os.path.exists(system.conf_dir+"/Tools-Hack"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
              else:
            ...
            if os.path.exists(system.home+"/Tools-Hack"):
              ...
              os.system("git clone https://github.com/Technical-Sid/Tool-X.git "+system.home+"/Tools-Hack")
            if os.path.exists(system.home+"/Tools-Hack/install.aex"):
              os.system("cd "+system.home+"/Tools-Hack && sh install.aex")
              if os.path.exists(system.bin+"/Tools-Hack") and os.path.exists(system.conf_dir+"/Tools-Hack"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Tools-Hack" or cmd=="unistall Tools-Hack":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Tools-Hack")
          os.system(system.sudo+" rm -rf "+system.bin+"/ToolsHack")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Tools-Hack")
        else:
          os.system("rm -rf "+system.bin+"/Tools-Hack")
          os.system("rm -rf "+system.bin+"/ToolsHack")
          os.system("rm -rf "+system.conf_dir+"/Tools-Hack")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Tools-Hack/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Tools-Hack/core/cat.json") as cat_file:
